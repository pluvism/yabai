...
export class MiddlewareEngine {
    ...
    add<K extends keyof MiddlewareMap>(type: K, fn: MiddlewareMap[K]): this {
        this.handlers[type].push(fn);
        return this;
    }

    get beforeHandle() {
        return this.handlers.beforeHandle;
    }
    get afterHandle() {
        return this.handlers.afterHandle;
    }
    get error() {
    ...
    set beforeHandle(fn) {
        this.handlers.beforeHandle = fn;
    }
    set afterHandle(fn) {
        this.handlers.afterHandle = fn;
    }
    set error(fn) {
